...
namespace CalculadoraTestes
{
    public class CalculadoraTeste
    {
        ...
        public void Calcular_DuasRaizesReais()
        {
            ...
            Assert.Equal(2.0, raiz1.Value, 1e-10);
            Assert.Equal(1.0, raiz2.Value, 1e-10);
        }
        ...
        public void Calcular_UmaRaizReal()
        {
            ...
            Assert.NotNull(raiz1);
            Assert.Null(raiz2);
            Assert.Equal(1.0, raiz1.Value, 1e-10);
        }
        ...
        public void Calcular_EquacaoInvalida()
        {
            ...
            Assert.Throws<ArgumentException>(() => Calculadora.CalcularRaizes(a, b, c));
        }
    }
}